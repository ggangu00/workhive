          ...
          <card>
            ...
            <div class="row justify-content-between align-items-end">
              ...
              <div class="selectbox col d-flex align-items-center">
                <select class="form-select w50" name="doc_kind" v-model="docKind">
                ...
                <select class="form-select w50" name="dept_nm" v-model="deptNm">
                ...
                <select class="form-select w50" name="form_cd" v-model="formType">
