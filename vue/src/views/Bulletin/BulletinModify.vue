      ...
      <div class="container-fluid">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <button class="btn btn-success btn-fill float-right" @click="editBulletin">저장</button>
...
const goToBulletinList = () => {
  if (!bbsId.value) {
    console.warn("bbsId 값이 없습니다. 기본 경로로 이동합니다.");
    router.push({ path: "/bulletin/bulletinList" });
  } else {
    router.push({ path: `/bulletin/bulletinList/${bbsId.value}` });
  }
};
